$(function () {
    ...
    $('#properties-slider').slick({
      slidesToShow: 4,
      slidesToScroll: 1,
      prevArrow: '<a href="#" class="slick-arrow slick-prev">trước</a>',
      nextArrow: '<a href="#" class="slick-arrow slick-next">sau</a>',
      responsive: [
        {
          breakpoint: 1100,
          settings: {
  ...
  //   const vanBach = {lat: 16.002344792987955, lng: 108.26700306446968};
  ...
  //     });
  // }
//   16.002344792987955, 108.26700306446968
  ...
  //       document.getElementById('map'), {zoom: 16, center: vanBach});
  //   // The marker, positioned at San Francisco
  //   const marker = new google.maps.Marker({position: vanBach, map: map});
  // }
    ...
    (function ($) {
        ...
        $(document).on('click', '.addToCompare', function () {
            ...
            if (inArray < 0) {
                ...
                if (list.length < 3) {
                    ...
                    $(".comparePan").append('<div id="' + productID + '" class="relPos titleMargin w3-margin-bottom   w3-col l3 m4 s4"><div class="w3-white titleMargin"><a class="selectedItemCloseBtn w3-closebtn cursor">&times</a><img src="' + image + '" alt="image" style="height:100px; margin-left:31%"/><p id="' + productID + '" class="titleMargin1">' + displayTitle + '</p></div></div>');
                }
            } else {
        ...
        $(document).on('click', '.cmprBtn', function () {
            if ($(".cmprBtn").hasClass("active")) {
                ...
                $(".contentPop").append('<div class="w3-col s3 m3 l3 compareItemParent relPos">' + '<ul class="product">' + '<li class=" relPos compHeader"><p class="w3-display-middle">Ảnh</p></li>' + '<li>Mã Tin</li>' + '<li>Diện Tích</li>' + '<li>Gác Lửng</li>' + '<li class="cpu">Mô Tả</li>' + '<li class="cpu">Địa Chỉ</li>' + '<li>Giá Thuê</li></ul>' + '</div>');
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    /*appending to div*/
                    $(".contentPop").append('<div class="w3-col s3 m3 l3 compareItemParent relPos">' + '<ul class="product">' + '<li class="compHeader"><img src="' + image + '" class="compareThumb"></li>' + '<li>' + title + '</li>' + '<li>' + $(product).data('size') + '</li>' + '<li>' + $(product).data('weight') + '<li class="cpu">' + $(product).data('processor') + '</li>'+ '<li class="cpu">' + $(product).data('address') + '</li>' + '<li>' + $(product).data('battery') + '</ul>' + '</div>');
                }
            }
            $(".modPos").show();
        });
